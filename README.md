...
Come tutte le comunità anche UDI ha un set di regole che vanno rispettate, la violazione di una o più regole può comportare un ban temporaneo o permanente dal gruppo stesso.
...
UDI approva e condivide pienamente tutti i termini e condizioni di utilizzo di Facebook, in particolare si ricorda che:
...
La vostra età, nazionalità, razza, preferenza sessuale o spirituale o stato economico non hanno rilevanza all'interno di UDI. Tutti sono i benvenuti nel gruppo, l'unico requisito richiesto per poter rimanere è saper comprendere, leggere e scrivere in lingua italiana.
...
- Inizia utilizzando l'hashtag `[#consulenza]` magari seguito dal topic più rilevante
...
```
[#Consulenza #{il tuo problema}]

Ciao a tutti.

Avrei un problema con {problema}
...
Ricordati che UDI non è un luogo per risolvere i tuoi problemi scolastici, la consulenza è un dare/avere. Chi verrà sorpreso ad aggirare le linee guida oppure a sfruttare in modo esagerato la disponibilità degli utenti potrà essere sospeso dal gruppo.
...
- Specifica l'azienda/team coinvolto
...
```
[#Lavoro #{Località} #{figura richiesta}]
...
Se fai parte dello staff di una conferenza e vuoi farla conoscere su UDI, sei il benvenuto!
...
* la conferenza non è gratuita, ma puoi mettere a disposizione degli utenti di UDI un buono sconto (in questo caso specifico, non postare subito ma scrivi prima ad uno degli amministratori);
